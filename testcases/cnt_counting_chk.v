task run_test;
    ...
    begin
        ...
        err = 0;
        $display("\n====================================");
        $display("====== Test Case: Counter Counting ====");
        $display("====================================");
        ...
        // PASS Case: Boundary of TDR0
        $display("--- PASS Case: Boundary of TDR0 ---");
        ...
        if (cnt[63:32] === 32'h1 && cnt[31:0] < 32'h10) begin
            $display("t=%10d PASS: TDR0 Boundary, TDR1 Expected=0x1, Actual=0x%h, TDR0=0x%h", $time, cnt[63:32], cnt[31:0]);
        end else begin
            $display("t=%10d FAIL: TDR0 Boundary, TDR1 Expected=0x1, Actual=0x%h, TDR0=0x%h", $time, cnt[63:32], cnt[31:0]);
            pass_err = pass_err + 1;
            err = err + 1;
        end
        test_bench.cmp_data(test_bench.ADDR_TDR1, cnt[63:32], 32'h1, 32'hFFFF_FFFF, 1);

        // PASS Case: Write TCMP0/TCMP1 and verify
